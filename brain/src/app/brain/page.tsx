...
export default async function BrainOverviewPage() {
  ...
  return (
    <div className="grid gap-5">
      <div>
        <h1 className="flex items-center gap-2 text-2xl font-bold"><Gauge className="size-6 text-[#21577d]" /> Overview</h1>
      ...
      <section className={card}>
        <div className="flex items-center gap-2"><Eye className="size-4 text-[#21577d]" /><h2 className="text-base font-bold">Effective prompt preview</h2></div>
        ...
        <div className="mt-2 grid gap-2">
          ...
          <div className="rounded-lg border border-[#f2e6da] bg-[#faf7f1] p-2.5 text-sm text-[#4b443b]">
            <div className="mb-1 text-xs font-bold uppercase tracking-wide text-[#21577d]">Your override</div>

      ...
      <div style={{ width: "100%", maxWidth: 380 }}>
        ...
        {state === "denied" ? (
          ...
          <form onSubmit={sendLink} style={{ display: "grid", gap: 10 }}>
            ...
            <button type="submit" disabled={state === "working"} style={{ ...field, height: 44, border: 0, background: "#7c3aed", color: "#fff", fontWeight: 600, cursor: "pointer", opacity: state === "working" ? 0.6 : 1 }}>

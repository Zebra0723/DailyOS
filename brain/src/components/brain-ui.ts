...
export const ACCENT = "#21577d";
export const card = "rounded-2xl border border-[#e6ded2] bg-[#fffdf9] p-4";
export const inputCls = "w-full rounded-lg border border-[#d9d2c6] bg-white p-2.5 text-sm outline-none focus:border-[#21577d]";
...
export const chipCls = "rounded-full border border-[#e6ded2] bg-[#faf7f1] px-3 py-1 text-xs font-semibold text-[#21577d] transition hover:bg-[#f2e6da]";
export const replyBox = "whitespace-pre-wrap rounded-lg border border-[#f2e6da] bg-[#faf7f1] p-2.5 text-sm text-[#4b443b]";
export const errBox = "rounded-lg border border-[#f0c4bd] bg-[#fbe9e7] p-2.5 text-sm text-[#21577d]";

  ...
  return (
    <span style={{ display: "inline-flex", alignItems: "center", gap: 10 }}>
      <svg viewBox="0 0 24 24" width="34" height="34" aria-hidden="true" style={{ flexShrink: 0 }}>
        <defs>
          <linearGradient id="brain-mark" x1="3" y1="3" x2="21" y2="21" gradientUnits="userSpaceOnUse">
            <stop offset="0" stopColor="#a78bfa" />
            <stop offset="1" stopColor="#6d28d9" />
          </linearGradient>
        </defs>
        <g fill="none" stroke="url(#brain-mark)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      {withText && (
        <span style={{ fontSize: 18, fontWeight: 700, letterSpacing: "-0.01em" }}>
          ...
          <span style={{ color: "#7c3aed", fontWeight: 600 }}>&nbsp;Brain</span>
        </span>
      )}
    </span>
  );

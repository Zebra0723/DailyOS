    ...
    <>
      ...
      {open && (
        ...
        >
          ...
          >
            <span style={{ display: "inline-block", fontSize: 11, fontWeight: 800, letterSpacing: "0.08em", textTransform: "uppercase", color: "#fff", background: "#c0392b", borderRadius: 999, padding: "3px 10px" }}>
              ⚠ Careful
            </span>

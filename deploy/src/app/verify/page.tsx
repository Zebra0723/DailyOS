  ...
  return (
    <main style={{ minHeight: "100vh", display: "grid", placeItems: "center", padding: 24 }}>
      <div style={{ width: "100%", maxWidth: 380 }}>
        ...
        <p style={{ color: "#6b6157", fontSize: 14, margin: "0 0 20px" }}>Verify your email to open DailyOS Deploy.</p>

        {state === "denied" ? (
          <div style={box("#fbe9e7", "#f0c4bd")}>
            This email doesn&apos;t have access to DailyOS Deploy.
          </div>
        ) : state === "sent" ? (
          ...
          <form onSubmit={sendLink} style={{ display: "grid", gap: 10 }}>
            ...
            <button type="submit" disabled={state === "working"} style={{ ...field, height: 44, border: 0, background: "#111827", color: "#fff", fontWeight: 600, cursor: "pointer", opacity: state === "working" ? 0.6 : 1 }}>

  ...
  return (
    <span style={{ display: "inline-flex", alignItems: "center", gap: 10 }}>
      <svg viewBox="0 0 24 24" width="34" height="34" aria-hidden="true" style={{ flexShrink: 0 }}>
        <defs>
          <linearGradient id="deploy-mark" x1="3" y1="3" x2="21" y2="21" gradientUnits="userSpaceOnUse">
            <stop offset="0" stopColor="#9ca3af" />
            <stop offset="1" stopColor="#111827" />
          </linearGradient>
        </defs>
        <g fill="none" stroke="url(#deploy-mark)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">

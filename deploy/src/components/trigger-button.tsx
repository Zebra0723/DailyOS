  ...
  return (
    <div>
      <ConfirmButton
        ...
        style={{ display: "inline-flex", background: enabled ? "#21577d" : "#9ca3af", color: "#fff", border: 0, borderRadius: 10, padding: "9px 16px", fontWeight: 700, fontSize: 14, cursor: enabled ? "pointer" : "not-allowed" }}
